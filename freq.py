...
strings=myfile.read().split() #we strip blank spaces at the beginning end.
#Removed punctuation that is used as phonetic notation in gyd & or included in the myp text
punctuation=['"',"#","%","&",")","+",",","-",".","/",":",";","<","=",">","@","[","]","^","`","{","}","~","]","¿","»","«","“","”","¡","،"] #Specific punctuation marks that we don0t want to take into account.
